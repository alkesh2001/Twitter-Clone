...
function StartPage() {
  return (
    <div className=" flex items-center justify-center h-screen  bg-black">
      <div
        className={`  mx-auto w-full lg:max-w-lg  max-w-[300px] rounded-xl p-10 border border-gray-800`}
      >
        ...
        <div className="flex items-center gap-4 justify-center py-4">
          <span className="border border-gray-600 rounded-xl w-24 mt-1"></span>
          <span className="text-xl font-medium text-white">or</span>
          <span className="border border-gray-600 rounded-xl w-24 mt-1"></span>
        </div>
        ...
        <div className="mt-7">
          <div className="flex justify-center items-center">
            <Link to="/Login">
              <span className="lg:text-xl text-md font-medium text-black py-2  px-4 rounded-xl bg-white">
                Login
              </span>
            </Link>
          </div>
